...
<a href="/csj/jsp/salesmen/HomePageSalesmen.jsp">Home(<%=(String)username%>)</a>
<li class="page-scroll">
<a href="/csj/jsp/salesmen/AddDeleteUpdateOrderSalesmen.jsp">Add New Order</a>
</li>
<li class="page-scroll">
<a href="/csj/jsp/salesmen/AddRole.jsp">Add Role</a>
</li>
<li class="page-scroll">
<a href="/csj/jsp/salesmen/Filters.jsp">Filters</a>
</li>
<!-- </li>
<li class="page-scroll">
<a href="/csj/jsp/customer/ListCartSalesmen.jsp">Cart</a>
</li>
<li class="page-scroll">
<a href="/csj/jsp/customer/ListOrderSalesmen.jsp">Order History</a>
</li>
<li class="page-scroll">
<a href="/csj/jsp/customer/FiltersSalesmen.jsp">Filters</a>
</li> -->
<li class="page-scroll">
