...
app.controller('ctrl', function($scope, $rootScope) {
  ...
  $scope.isValidCardType = function() {
	    if ($scope.selectCardType.availableOptions == "") {
  ...
  $scope.isValidBA = function() {
    ...
    $scope.isValidExpMonth = function() {
	    if ($scope.selectMonth.availableOptions == "") {
    ...
    $scope.isValidExpYear = function() {
	    if ($scope.selectYear.availableOptions == "") {
  ...
  $scope.onClickSubmit = function(id) {
  ...
  document.OrderFromCart.appendChild(input);
  document.OrderFromCart.action = "/csj/jsp/customer/Order.jsp";
  document.OrderFromCart.submit();
  };
